...
function renderFAQs(category: string) {
  ...
  filteredFAQs.forEach((faq) => {
    ...
    faqItem.innerHTML = `
    <div class="p-4 px-5 bg-gray-100 rounded-lg">
        <div class="flex gap-2 items-top justify-between cursor-pointer">
          <h3 class="text-neutral-800 font-semibold text-left w-11/12">${faq.question}</h3>
